...
> A new version of the [`nloptr`](https://astamm.github.io/nloptr/) package has been released! The [NLopt](https://nlopt.readthedocs.io/en/latest/) library has switched to [CMake](https://cmake.org) as build system. I am replacing Jelmer Ypma as maintainer of the package.

## `nlopt`

The NLopt library [@nlopt] is a free/open-source library for nonlinear optimization, providing a common interface for a number of different free optimization routines available online as well as original implementations of various other algorithms.
