...
## Anatomy of mathematics research {visibility="hidden"}

::: {.callout-note}
## Key Personnel

- **Principal Investigators**: Mathematics professors/researchers leading theoretical developments
- **Postdoctoral Researchers**: Contributing to both theoretical work and implementation
- **PhD Students**: Working on specific theoretical or computational aspects
- **Software Engineers**: Supporting robust implementation of methods
:::
...
## Math. research in health sciences {visibility="hidden"}

### Key Personnel

- **Mathematical Team**: Statisticians, applied mathematicians
- **Medical Team**: Clinicians, neurologists, physiotherapists
- **Technical Team**: Biomedical engineers, software developers
- **Research Support**: Data managers, clinical research assistants

## Math. research in health sciences {visibility="hidden"}

### Core Interactions

1. **Clinical-Mathematical Interface**
- Regular meetings between clinicians and mathematicians
- Translation of clinical questions into mathematical problems
- Interpretation of mathematical results in clinical terms
...
- Protocol testing with clinicians
- Feedback integration
- Result validation in clinical settings
...
::: {layout="[[-1], [1], [-1]]"}
![](images/egait-ms-movie.mov){width=100% fig-align="center"}
:::
